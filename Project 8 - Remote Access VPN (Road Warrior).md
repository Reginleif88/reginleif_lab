---
title: "Project 8: Remote Access VPN (Road Warrior)"
...
## Goal
Configure a "Road Warrior" WireGuard peer for the Administrator's Home PC. This allows secure, direct access to the Royal Server (`P-WIN-SRV1`) and other internal lab resources (`172.16.0.0/24` and `172.17.0.0/24`) without exposing management ports (like 54899) to the main Home Network.
...
4.  **Edit Instance:**
    *   Select the existing "Site-to-Site" instance.
